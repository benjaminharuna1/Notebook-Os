...
```json
{
  "research_objective": "To replace recurrent and convolutional sequence models with a purely attention-based architecture, testing whether self-attention alone is sufficient for state-of-the-art machine translation.",
  "methodology": "Proposes the Transformer, built on multi-head self-attention and position-wise feed-forward layers, trained on WMT 2014 English-to-German and English-to-French translation tasks.",
  "key_findings": "The Transformer reaches BLEU scores of 28.4 on English-to-German and 41.8 on English-to-French, outperforming previous ensembles while training significantly faster and in parallel.",
